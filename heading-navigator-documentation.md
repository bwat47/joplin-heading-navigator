...
- `src/logger.ts`: Centralized logger with optional debug toggle. Provides consistent prefixing for all plugin logs and exposes a simple `setDebug` method to enable verbose output.
